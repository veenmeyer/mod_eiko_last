...
while($i < $count_fields)
   { 
		...
		if (trim($fields[$i])=="Einsatzfoto"): if ($reports[$a]->foto): ?><tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></td></tr><?php endif;?><?php endif;
		...
		if (trim($fields[$i])=="Einsatzfoto_Karte"): if ($reports[$a]->foto): ?><tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></td></tr><?php else: if ($reports[$a]->gmap):?><tr class="eiko_last_karte_tr"><td class="eiko_last_karte_td"><img class="img-rounded eiko_last_karte" src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&zoom=<?php echo $params->get('zoom','12');?>&size=600x300&maptype=roadmap&markers=color:red%7Clabel:x%7C<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&key=<?php echo $params->get('gmapkey','AIzaSyAuUYoAYc4DI2WBwSevXMGhIwF1ql6mV4E');?>" width="100%" alt="Einsatzkarte <?php echo $reports[$a]->summary;?>"></td></tr><?php endif;?><?php endif;?><?php endif;
...
&markers=color:red%7Clabel:x%7C<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&key=<?php echo $params->get('gmapkey','AIzaSyAuUYoAYc4DI2WBwSevXMGhIwF1ql6mV4E');?>" width="100%" alt="Einsatzkarte <?php echo $reports[$a]->summary;?>"></a></td></tr><?php endif;
		...
		if (trim($fields[$i])=="Einsatznummer"):?><tr class="eiko_last_counter_tr">
			...
			<?php echo '<small>#'.EinsatzkomponenteHelper::ermittle_einsatz_nummer($curTime,$reports[$a]->data1).'/'.date('Y', $curTime).'</small>';?>
