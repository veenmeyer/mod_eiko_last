...
while($i < $count_fields)
   { 
    	...
    	if (trim($fields[$i])=="Einsatzort"):?><tr class="eiko_last_einsatzort_tr"><td class="eiko_last_einsatzort_td"><span  class="eiko_last_einsatzort_span"><?php echo echo $params->get('einsatzort_zusatz').$reports[$a]->address;?></span></td></tr><?php endif;
