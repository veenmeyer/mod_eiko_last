...
while($i < $count_fields)
   { 
		...
		if (trim($fields[$i])=="Einsatzfoto"): if ($reports[$a]->foto): ?>
		<?php $reports[$a]->foto = preg_replace("%thumbs/%", "", $reports[$a]->foto,1); ?>
		<tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></td></tr><?php endif;?><?php endif;
		if (trim($fields[$i])=="Einsatzfoto_Link"): if ($reports[$a]->foto): ?>
		<?php $reports[$a]->foto = preg_replace("%thumbs/%", "", $reports[$a]->foto,1); ?>
		<tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><a class="eiko_last_image_link" href="<?php echo JRoute::_('index.php?option=com_einsatzkomponente&Itemid='.$mymenuitem.'&view=einsatzbericht&id=' . (int)$reports[$a]->id); ?>"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></a></td></tr><?php endif;?><?php endif;
		
		if (trim($fields[$i])=="Einsatzfoto_Karte"): if ($reports[$a]->foto): ?>
		<?php $reports[$a]->foto = preg_replace("%thumbs/%", "", $reports[$a]->foto,1); ?>
		<tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></td></tr><?php else: if ($reports[$a]->gmap):?><tr class="eiko_last_karte_tr"><td class="eiko_last_karte_td"><img class="img-rounded eiko_last_karte" src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&zoom=<?php echo $params->get('zoom','12');?>&size=600x300&maptype=roadmap&markers=color:red%7Clabel:x%7C<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&key=<?php echo $params->get('gmapkey','');?>" width="100%" alt="Einsatzkarte <?php echo $reports[$a]->summary;?>"></td></tr><?php endif;?><?php endif;?><?php endif;
		
		if (trim($fields[$i])=="Einsatzfoto_Karte_Link"): if ($reports[$a]->foto): ?>
		<?php $reports[$a]->foto = preg_replace("%thumbs/%", "", $reports[$a]->foto,1); ?>
		<tr class="eiko_last_image_tr"><td class="eiko_last_image_td"><a class="eiko_last_image_link" href="<?php echo JRoute::_('index.php?option=com_einsatzkomponente&Itemid='.$mymenuitem.'&view=einsatzbericht&id=' . (int)$reports[$a]->id); ?>"><img class="img-rounded eiko_last_image" src="<?php echo $reports[$a]->foto;?>" width="100%" alt="Einsatzfoto <?php echo $reports[$a]->summary;?>"></a></td></tr><?php else: if ($reports[$a]->gmap):?><tr class="eiko_last_karte_tr"><td class="eiko_last_karte_td"><a class="eiko_last_karte_link" href="<?php echo JRoute::_('index.php?option=com_einsatzkomponente&Itemid='.$mymenuitem.'&view=einsatzbericht&id=' . (int)$reports[$a]->id); ?>"><img class="img-rounded eiko_last_karte" src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&zoom=<?php echo $params->get('zoom','12');?>&size=600x300&maptype=roadmap&markers=color:red%7Clabel:x%7C<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&key=<?php echo $params->get('gmapkey','AIzaSyAuUYoAYc4DI2WBwSevXMGhIwF1ql6mV4E');?>" width="100%" alt="Einsatzkarte <?php echo $reports[$a]->summary;?>"></a></td></tr><?php endif;?><?php endif;?><?php endif;
		
		
		
		if (trim($fields[$i])=="Einsatzkarte"):?><tr class="eiko_last_karte_tr"><td class="eiko_last_karte_td"><img class="img-rounded eiko_last_karte" src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&zoom=<?php echo $params->get('zoom','12');?>&size=600x300&maptype=roadmap
&markers=color:red%7Clabel:x%7C<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&key=<?php echo $params->get('gmapkey','AIzaSyAuUYoAYc4DI2WBwSevXMGhIwF1ql6mV4E');?>" width="100%" alt="Einsatzkarte <?php echo $reports[$a]->summary;?>"></td></tr><?php endif;
		...
		if (trim($fields[$i])=="Einsatzkarte_Link"): ?><tr class="eiko_last_karte_tr"><td class="eiko_last_karte_td"><a class="eiko_last_karte_link" href="<?php echo JRoute::_('index.php?option=com_einsatzkomponente&Itemid='.$mymenuitem.'&view=einsatzbericht&id=' . (int)$reports[$a]->id); ?>"><img class="img-rounded eiko_last_karte" src="https://maps.googleapis.com/maps/api/staticmap?center=<?php echo $reports[$a]->gmap_report_latitude;?>,<?php echo $reports[$a]->gmap_report_longitude;?>&zoom=<?php echo $params->get('zoom','12');?>&size=600x300&maptype=roadmap
